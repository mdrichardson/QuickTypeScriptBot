...
export class LuisRecognizer {
    ...
    constructor(application: LuisApplication|LuisApplicationWithRotatingKeys|string, options?: LuisPredictionOptions, includeApiResults?: boolean) {
        if (typeof application === 'string') {
            ...
            this.application = {
                ...
                endpointKeyRotation: (<LuisApplication>application).endpointKey ? [(<LuisApplication>application).endpointKey] : (<LuisApplicationWithRotatingKeys>application).endpointKeyRotation,
            };           
        }
        ...
        (<LuisApplicationWithRotatingKeys>this.application).endpointKeyRotation.forEach((key) => {
    ...
    private validateLuisApplication(): void {
        ...
        if (!(<LuisApplicationWithRotatingKeys>this.application).endpointKeyRotation) {
            throw new Error(`Invalid \`endpointKey\` value detected: ${(<LuisApplicationWithRotatingKeys>this.application).endpointKeyRotation}\nPlease make sure your endpointKey is a valid LUIS Endpoint Key, e.g. "048ec46dc58e495482b0c447cfdbd291".`);
        }
    }

    private getLuisEndpointKeyAndRotateIndex(): string {
        const endpointKey = (<LuisApplicationWithRotatingKeys>this.application).endpointKeyRotation[this.luisClientIndex];
