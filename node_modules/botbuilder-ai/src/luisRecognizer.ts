...
export class LuisRecognizer implements LuisRecognizerTelemetryClient{
    ...
    constructor(application: LuisApplication|LuisApplicationWithRotatingKeys, options?: LuisPredictionOptions, includeApiResults?: boolean, telemetryClient?: BotTelemetryClient, logPersonalInformation?: boolean);
    constructor(application: LuisApplication|LuisApplicationWithRotatingKeys|string, options?: LuisPredictionOptions, includeApiResults?: boolean, telemetryClient?: BotTelemetryClient, logPersonalInformation?: boolean) {
        let tempApplication: LuisApplicationWithRotatingKeys;
   ...
   /**
    ...
    protected async fillTelemetryProperties(recognizerResult: RecognizerResult, turnContext: TurnContext, telemetryProperties?: {[key: string]:string}): Promise<{[key: string]:string}> {
        ...
        properties[LuisTelemetryConstants.applicationIdProperty] = this.appId;
