...
export class LuisRecognizer {
    ...
    private nextLuisClientIndex: number = 0;
    ...
    public recognize(context: TurnContext): Promise<RecognizerResult> {
        ...
        if (!cached) {
            ...
            const endpointKey = this.rotateLuisClientAndGetKey();
    ...
    private rotateLuisClientAndGetKey(): string {
        this.luisClient = this.luisClients[this.nextLuisClientIndex];
        const endpointKey = (<LuisApplicationWithRotatingKeys>this.application).endpointKeyRotation[this.nextLuisClientIndex];
        this.nextLuisClientIndex = this.nextLuisClientIndex + 1 < this.luisClients.length ? this.nextLuisClientIndex + 1 : 0;
        return endpointKey;
    }
}
