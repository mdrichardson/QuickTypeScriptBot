...
export class LuisRecognizer {
    ...
    constructor(application: LuisApplication|LuisApplicationWithRotatingKeys|string, options?: LuisPredictionOptions, includeApiResults?: boolean) {
        ...
        // TODO: Make this work with new interface
        } else {
            const { applicationId, endpoint } = application;
            if (application.endpointKey) {
                this.application = {
                    applicationId,
                    endpoint,
                    endpointKey: application.endpointKey,
                };
            } else {
                this.application = {
                    applicationId,
                    endpoint,
                    endpointKeyRotation: application.endpointKey,
                } as LuisApplicationWithRotatingKeys;
            }            
        }
        ...
        this.application.endpointKey = this.application.endpointKey as string[]; // It is already a string[], but this keeps tslint from yelling
        this.application.endpointKey.forEach((key) => {
    ...
    private rotateLuisClientAndGetKey(): string {
        ...
        const endpointKey = this.application.endpointKey[this.nextLuisClientIndex];
