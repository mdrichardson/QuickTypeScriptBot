...
export class LuisRecognizer {
    private application: LuisApplicationWithRotatingKeys|LuisApplication;
    ...
    public recognize(context: TurnContext): Promise<RecognizerResult> {
        ...
        if (!cached) {
            ...
            const currentEndpointKey = this.getCurrentLuisClientKey();
            ...
            return this.luisClients[currentClientIndex].prediction.resolve(
                this.application.applicationId, utterance,
                {
                    ...
                    customHeaders: {
                        'Ocp-Apim-Subscription-Key': currentEndpointKey,
     ...
     */
    private createLuisClientsArray(): void {
        const baseUri: string = this.application.endpoint || 'https://westus.api.cognitive.microsoft.com';
        (this.application as LuisApplicationWithRotatingKeys).endpointKeysToRotate.forEach((key) => {
    ...
    private validateLuisApplication(): void {
        ...
        if (!(this.application as LuisApplicationWithRotatingKeys).endpointKeysToRotate || (this.application as LuisApplicationWithRotatingKeys).endpointKeysToRotate.length <= 0) {
            throw new Error(`Invalid \`endpointKey\` value detected: ${ (this.application as LuisApplicationWithRotatingKeys).endpointKeysToRotate }\nPlease make sure your endpointKey is a valid LUIS Endpoint Key, e.g. "048ec46dc58e495482b0c447cfdbd291".`);
        }
    }
