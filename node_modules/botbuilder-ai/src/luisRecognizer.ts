...
export class LuisRecognizer implements LuisRecognizerTelemetryClient{
    ...
    constructor(application: LuisApplication|LuisApplicationWithRotatingKeys, options?: LuisPredictionOptions, includeApiResults?: boolean);
    constructor(application: LuisApplication|LuisApplicationWithRotatingKeys|string, options?: LuisPredictionOptions, includeApiResults?: boolean) {
