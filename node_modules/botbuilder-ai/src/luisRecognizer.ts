 ...
 */
export interface AllLuisApplications {
    /**
 ...
 */
export interface LuisApplication extends AllLuisApplications {
    /**
 ...
 */
export interface LuisApplicationWithRotatingKeys extends AllLuisApplications {
    /**
     * Array of endpoint keys for talking to LUIS, each one called in rotating turn
     */
    endpointKeyRotation: string[];
}
...
export class LuisRecognizer {
    ...
    public constructor(application: LuisApplication|LuisApplicationWithRotatingKeys|string, options?: LuisPredictionOptions, includeApiResults?: boolean) {
        if (typeof application === 'string') {
            ...
            this.application = {
                applicationId,
                endpoint,
                // Convert to LuisApplicationWithRotatingKeys with single key in endpointKeyRotation array, as necessary
                endpointKeyRotation: (application as LuisApplication).endpointKey ? [(application as LuisApplication).endpointKey] : (application as LuisApplicationWithRotatingKeys).endpointKeyRotation,
            };           
        }
        ...
        (this.application as LuisApplicationWithRotatingKeys).endpointKeyRotation.forEach((key) => {
    ...
    public recognize(context: TurnContext): Promise<RecognizerResult> {
        ...
        if (!cached) {
            ...
            const endpointKey = this.getLuisEndpointKeyAndRotateIndex();
    ...
    private validateLuisApplication(): void {
        ...
        if (!(this.application as LuisApplicationWithRotatingKeys).endpointKeyRotation) {
            throw new Error(`Invalid \`endpointKey\` value detected: ${ (this.application as LuisApplicationWithRotatingKeys).endpointKeyRotation }\nPlease make sure your endpointKey is a valid LUIS Endpoint Key, e.g. "048ec46dc58e495482b0c447cfdbd291".`);
        }
    }

    private getLuisEndpointKeyAndRotateIndex(): string {
        const endpointKey = (this.application as LuisApplicationWithRotatingKeys).endpointKeyRotation[this.luisClientIndex];
