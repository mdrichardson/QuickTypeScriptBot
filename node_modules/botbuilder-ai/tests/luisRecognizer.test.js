...
function GetExpected(oracle, customEndpointKey=null) {
    ...
    var appropriateEndpointKey = customEndpointKey || endpointKey;
    if (customEndpointKey) {
        expected.requestEndpointKeyUsed = appropriateEndpointKey;
    }

    if (mockLuis) {
        nock('https://westus.api.cognitive.microsoft.com')
            .matchHeader('Ocp-Apim-Subscription-Key', appropriateEndpointKey)
            .matchHeader('authorization', `Bearer ${appropriateEndpointKey}`)
