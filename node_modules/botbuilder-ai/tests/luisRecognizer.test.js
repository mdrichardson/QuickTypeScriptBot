...
function GetExpected(oracle, customEndpointKey=null) {
    ...
    if (mockLuis) {
        nock('https://westus.api.cognitive.microsoft.com')
            .matchHeader('Ocp-Apim-Subscription-Key', customEndpointKey || endpointKey)
            .matchHeader('authorization', `Bearer ${ customEndpointKey || endpointKey }`)
...
describe('LuisRecognizer', function() {
    ...
    it('should rotate endpointKeys when usin LuisApplicationWithRotatingKeys', done => {
    ...
    it('should successfully construct with valid endpoint.', () => {
        ...
        assert(recognizer.application.endpointKeysToRotate[0] === '048ec46dc58e495482b0c447cfdbd291');
